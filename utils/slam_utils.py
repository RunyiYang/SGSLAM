...
def disparity_loss(depth_render, depth_da, count):
    ...
    scale_dir = '/scratch_net/biwidl307/wenxuan/MonoGS/tum_desk_paper_images/scale_render_office'
    translation_dir = '/scratch_net/biwidl307/wenxuan/MonoGS/tum_desk_paper_images/translation_render_office'
    loss_dir = '/scratch_net/biwidl307/wenxuan/MonoGS/tum_desk_paper_images/loss_render_office'
    ...
    np.save(f'{scale_dir}/combined_{count}', optimal_scale)
    np.save(f'{translation_dir}/combined_{count}', optimal_translation)
    np.save(f'{loss_dir}/combined_{count}', optimal_l1_loss)
